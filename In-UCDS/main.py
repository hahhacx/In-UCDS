...
print(SPLIT)
print("Load dataset...")
# dataset = MyDataset.MyDatasetFromFile(data_path, args.split, args.random_seed)
# dataset = MyDataset.MyDatasetNew(data_path, args.split, normalize=False, neighbor_num=1)
...
# train_data, tune_data, test_data, user_num, item_num, active_users, users, user_list, item_list \
#     = dataset.generate_train_tune_test()
# test_user_set, test_item_set, test_labels, tune_user_set, tune_item_set, tune_labels \
#     = dataset.instance_tune_test_sample()
...
#UCDS Modeling
InUCDS = ucds.InUCDS(num_users = user_num,active_ids = active_users,inactive_ids = inactive_users, similarity_matrix = similarity_matrix)
