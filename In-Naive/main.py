...
def train_InNaive(epoch):
    ...
    for batch_idx, data in tqdm(enumerate(sample_generator)):
        ...
        inactive_embedding_samples = model_fair.inactive_embeddings_for_my_loss(active_inactive_samples)
        neighbor_embedding_samples = model_fair.neighbor_embeddings_for_my_loss(active_inactive_samples)
        # add abs
